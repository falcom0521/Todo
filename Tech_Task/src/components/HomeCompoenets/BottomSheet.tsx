  ...
  export default function TaskCreation() {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        console.log("New Task:", newTask); // Debugging line
    
        const db = getDatabase();
        const tasksRef = ref(db, 'tasks/' + newTask.id);
        
        await set(tasksRef, newTask);
    
        console.log("Task saved to Firebase:", newTask); // Debugging line
        ...
        sheetRef.current?.close();
         ...
         .error("Error saving task to Firebase:", error); // Detailed error logging
      }
    };
        ...
        <View style={styles.container}>
          <View style={styles.InputCont1}>
            <TextInput
              ...
              placeholder="Input new title task"
            />
          </View>
